    ...
    <section id="about" className="bg-surface py-16 md:py-[100px] px-6 md:px-[60px]">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-center max-w-[1200px] mx-auto">
        ...
        <div>
          ...
          <h2 className="font-display text-[clamp(2.8rem,3.8vw,4rem)] leading-[0.95] tracking-wide mb-2">
  ...
  return (
    <section id="network" className="bg-bg py-16 md:py-[40px] px-6 md:px-[60px] text-center">
      <div className="max-w-[1100px] mx-auto">
        ...
        <div className="font-display text-[clamp(2rem,3vw,2.4rem)] tracking-[0.05em] text-white/30 mb-6 leading-relaxed">
